...
//#endif
    ...
    // Note that modifying the projection here causes issues.
...
{
    v[0] = mWindowRectRaw.mLeft + xOffset;
    v[1] = mWindowRectRaw.mBottom + yOffset;
...
{
    v[0] = mWorldViewRectRaw.mLeft   + xOffset;
    v[1] = mWorldViewRectRaw.mBottom + yOffset;
